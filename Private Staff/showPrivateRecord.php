                ...
                <tbody>
                    ...
                    if ($result) {
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            <td>'.$cn.'</td>
                            <td>'.$cd.'</td>
                            <td><a href="psFullDetails.php?personId='.$id.'&loc=showPrivateRecord" class="fullDetails" onmouseover="this.style.color = "#ff7c0a" " onmouseout="this.style.color = "black" " style="text-decoration: none; color: black">View Details</a></td>
                        </tr>';  
