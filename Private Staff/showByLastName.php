    ...
    <section class="p-5">
        <div class="table-responsive" id="no-more-tables">
            <table class="table  my-5">
                ...
                <tbody>
                    <?php
                    $sql = "select * from `register` where last_name='$certificate' ";
                    ...
                    if ($result) {
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            <td>'.$cn.'</td>
                            <td>'.$cd.'</td>
                            <td><a href="psFullDetails.php?personId='.$id.'&loc=showByLastName" class="fullDetails" onmouseover="this.style.color = "#ff7c0a" " onmouseout="this.style.color = "black" " style="text-decoration: none; color: black">View Details</a></td>
                        </tr>';  
